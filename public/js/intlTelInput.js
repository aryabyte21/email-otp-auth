  ...
  return (function() {
    ...
    var Iti = function(input, options) {
      ...
      forEachProp(defaults, function(key, value) {
        that.options[key] = customOptions.hasOwnProperty(key)
          ? customOptions[key]
          : value;
      });
    ...
    Iti.prototype = {
      ...
      _initHiddenInputListener: function() {
        ...
        if (form)
          form.addEventListener("submit", this._handleHiddenInputSubmit);
      },
      ...
      _initDropdownListeners: function() {
        ...
        this._handleClickSelectedFlag = function() {
          ...
          if (
            that.countryList.classList.contains("hide") &&
            !that.telInput.disabled &&
            !that.telInput.readOnly
          ) {
            that._showDropdown();
          }
        };
      ...
      _initFocusListeners: function() {
        ...
        this._handleMousedownFocusEvent = function(e) {
          if (
            that.telInput !== document.activeElement &&
            !that.telInput.value
          ) {
            e.preventDefault();
        ...
        this._handleFocusEvent = function(e) {
          if (
            ...
            that.telInput.addEventListener(
              "keypress",
              that._handleKeypressPlusEvent
            );
        ...
        var form = this.telInput.form;
        if (form)
          form.addEventListener("submit", this._handleSubmitOrBlurEvent);
      ...
      _setDropdownPosition: function() {
        ...
        if (!this.isMobile) {
          var pos = this.telInput.getBoundingClientRect(), // windowTop from https://stackoverflow.com/a/14384091/217866
            ...
            dropdownHeight = this.countryList.offsetHeight, // dropdownFitsBelow = (dropdownBottom < windowBottom)
            dropdownFitsBelow =
          ...
          if (this.options.dropdownContainer) {
            ...
            this.dropdown.style.left =
              "" + (pos.left + document.body.scrollLeft) + "px";
      ...
      _updateFlagFromNumber: function(number) {
        ...
        if (dialCode) {
          ...
          var countryCodes = this.countryCodes[this._getNumeric(dialCode)],
            alreadySelected =
              countryCodes.indexOf(this.selectedCountryData.iso2) !== -1, // check if the given number contains a NANP area code i.e. the only dialCode that could be extracted was +1 (instead of say +1204) and the actual number's length is >=4
